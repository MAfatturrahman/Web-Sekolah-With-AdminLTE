            ...
            <form method="POST" action="{{ route('role.update', $role->id) }}">
                ...
                <div class="d-flex gap-2 flex-column flex-md-row">
                    ...
                    <div class="d-flex flex-column lh-1">
                        ...
                        <div class="form-group">
                            <input type="checkbox" {{ in_array('view-history', $permissions) ? 'checked' : '' }}
                                name="permission[]" value="view-history">
                            <label for="role">view-history</label>
                        </div>
                        <div class="form-group">
                            <input type="checkbox" {{ in_array('show-history', $permissions) ? 'checked' : '' }}
                                name="permission[]" value="show-history">
